...
const features = [
    {
        ...
        description:
            "Our team of skilled developers, designers, and IT specialists brings extensive industry knowledge and technical expertise to every project.",
    },
    {
        icons: ComputerIcon,
        title: "Tailor-made technology solutions",
        description:
            "We understand that every business is unique. That's why we create customized solutions designed to meet your specific goals and requirements.",
    },
    {
        icons: HandCoinsIcon,
        title: "Affordable and competitive pricing",
        description:
            "Our services are designed to deliver exceptional value with transparent, cost-effective pricing that fits your budget.",
    },
    {
        icons: PhoneCallIcon,
        title: "Transparent communication",
        description:
            "We believe in open and honest communication, keeping you informed throughout every stage of your project's lifecycle.",
    },
    {
        icons: ClipboardClockIcon,
        title: "Timely project delivery",
        description:
            "We follow efficient project management practices to ensure your project is completed on schedule without compromising quality.",
    },
    {
        icons: ShieldCheckIcon,
        title: "Commitment to quality and innovation",
        description:
            "We combine modern technologies, industry best practices, and innovative thinking to deliver secure, scalable, and future-ready digital solutions.",
    },
];
